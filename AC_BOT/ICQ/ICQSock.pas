...
type
  ...
  TOnSocketThreadException = procedure (Sender: TObject; AExceptionStr: String) of object; 
  ...
  TOnAdvPktParse = procedure(Sender: TObject; Host: String; Port: Word; Buffer: Pointer; BufLen: LongWord; Incoming: Boolean) of object;
